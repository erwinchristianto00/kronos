...
const derivation: FoundryDerivationIdentity = { version: "foundry-derivation-v1", policyVersion: "risk-v1", parameters: { fixture: true }, parentSemanticManifestHashes: ["a".repeat(64)] };
