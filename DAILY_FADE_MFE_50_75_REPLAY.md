...
- Closed Fade records: 27.
- Path quality: 18 `APPROX_1M`, 1 `INCOMPLETE`, 8 `MISSING`.
- Stored extrema indicate 8 records reached at least 50% of the frozen target and 3 reached at least 75%.
- Extrema timestamp is available for 19 records.
